...
class Logger(object):
    ...
    用来写日志用的
    """
    def __init__(self, filename=todaylog+'.log', stream=sys.stdout):
...
if __name__ == '__main__':
    ...
    base_url = 'http://www.czce.com.cn/cn/DFSStaticFiles/Future/' + today_year + '/' + today + '/FutureDataHolding.htm'
    print(base_url)
