...
msgEmail = "a502337328@163.com" # text message email address here.
loginName = "502337328@qq.com" # imap login name ; gmail uses id@gmail.com
loginPassword = "pyvkddivykqlbicc" # imap password
